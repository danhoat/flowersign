...
<link rel="stylesheet" type="text/css" href="css/common.css?date=20241013&amp;v=11">
...
<!-- 꽃청 수정 START 윤상희 2023.04.07 - 네비게이션 수정 -->
    ...
    <li class="categoryDepth1">
        ...
        <a class="categoryDepthLink" href="/goods/catalog_list?code=0006"><em>택배특가</em></a>
            </li>
    <li class="categoryDepth1">
        <div class="nav_comment nav_comment_diy"><span>NEW</span></div>
...
<div class="resp_wrap" style="position:relative;">
    ...
    <div class="title_group1" style="display:block;">
        <h3 class="title1"><span designelement="text" textindex="1" texttemplatepath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWFpbi9pbmRleC5odG1s">추천상품</span></h3>
...
<ul class="goods_list swiper-slide">    <li class="gl_item">
    ...
    <div class="gl_inner_item_wrap">
        ...
        <div class="gli_image goodsDisplayImageWrap">
            <a href="javascript:void(0);" class="respItemImageArea" onclick="display_goods_view('102','',this,'goods_view')">
                <img src="https://f-mans.com/data/goods/1/2023/10/102_temp_16972447025344list1.jpg" data-src="https://f-mans.com/data/goods/1/2023/10/102_temp_16972447025344list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="천냥금(백량금) 모던라인">
            </a>
            ...
            <!-- 반응형 zzim -->
            <div class="respGoodsZzim">
                <a class="zzimArea" href="javascript:void(0)" onclick="display_goods_zzim(this, 102)">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim/icon_zzim.png" class="zzimImage normal " alt="찜하기" title="찜하기">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim_on/icon_zzim_on.png" class="zzimImage active hide" alt="찜한 상품" title="찜한 상품">
                </a>
            </div>
            ...
            <div class="respGoodsFuncMenu">
                <ul class="goodsDisplayItemWrap">
                    <li class="funcMenu_quickview"><a href="javascript:void(0)" onclick="display_goods_quickview(this, 102);"><span class="txt">미리보기</span></a></li>
                    <li class="funcMenu_option"><a href="javascript:void(0)" onclick="display_goods_show_opt(this, 102);"><span class="txt">옵션보기</span></a></li>
                    <li class="funcMenu_send"><a href="javascript:void(0)" onclick="display_goods_send(this,'bottom', '102', '천냥금(백량금) 모던라인' );"><span class="txt">SNS보내기</span></a></li>
                </ul>
            </div>
    ...
    <div class="gl_inner_item_wrap">
        ...
        <div class="gli_image goodsDisplayImageWrap">
            <a href="javascript:void(0);" class="respItemImageArea" onclick="display_goods_view('77','',this,'goods_view')">
                <img src="https://f-mans.com/data/goods/1/2023/10/77_temp_16972508563924list1.jpg" data-src="https://f-mans.com/data/goods/1/2023/10/77_temp_16972508563924list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="아름다운기억">
            </a>
            ...
            <!-- 반응형 zzim -->
            <div class="respGoodsZzim">
                <a class="zzimArea" href="javascript:void(0)" onclick="display_goods_zzim(this, 77)">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim/icon_zzim.png" class="zzimImage normal " alt="찜하기" title="찜하기">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim_on/icon_zzim_on.png" class="zzimImage active hide" alt="찜한 상품" title="찜한 상품">
                </a>
            </div>
            ...
            <div class="respGoodsFuncMenu">
                <ul class="goodsDisplayItemWrap">
                    <li class="funcMenu_quickview"><a href="javascript:void(0)" onclick="display_goods_quickview(this, 77);"><span class="txt">미리보기</span></a></li>
                    <li class="funcMenu_option"><a href="javascript:void(0)" onclick="display_goods_show_opt(this, 77);"><span class="txt">옵션보기</span></a></li>
                    <li class="funcMenu_send"><a href="javascript:void(0)" onclick="display_goods_send(this,'bottom', '77', '아름다운기억' );"><span class="txt">SNS보내기</span></a></li>
                </ul>
            </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        <!-- 상품명-->
        <div class="goodS_info displaY_goods_name">
            <span class="areA"><a href="/goods/view?no=77">아름다운기억</a></span>
        </div>
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">아름다운 기억은 장미, 계절꽃으로 구성된 꽃바구니입니다.</span>
        </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">'행운이 찾아온다'는 의미를 담은 만천홍(미니호접란)</span>
        </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">7위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">8위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">9위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
    ...
    <div class="gl_inner_item_wrap">
        ...
        <div class="gli_image goodsDisplayImageWrap">
            <a href="javascript:void(0);" class="respItemImageArea" onclick="display_goods_view('72','',this,'goods_view')">
                <img src="https://f-mans.com/data/goods/1/2024/06/72_temp_17173996940531list1.jpg" data-src="https://f-mans.com/data/goods/1/2024/06/72_temp_17173996940531list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="진심(수국꽃다발)">
            </a>
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">10위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
            ...
            <!-- 반응형 zzim -->
            <div class="respGoodsZzim">
                <a class="zzimArea" href="javascript:void(0)" onclick="display_goods_zzim(this, 72)">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim/icon_zzim.png" class="zzimImage normal " alt="찜하기" title="찜하기">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim_on/icon_zzim_on.png" class="zzimImage active hide" alt="찜한 상품" title="찜한 상품">
                </a>
            </div>
            ...
            <div class="respGoodsFuncMenu">
                <ul class="goodsDisplayItemWrap">
                    <li class="funcMenu_quickview"><a href="javascript:void(0)" onclick="display_goods_quickview(this, 72);"><span class="txt">미리보기</span></a></li>
                    <li class="funcMenu_option"><a href="javascript:void(0)" onclick="display_goods_show_opt(this, 72);"><span class="txt">옵션보기</span></a></li>
                    <li class="funcMenu_send"><a href="javascript:void(0)" onclick="display_goods_send(this,'bottom', '72', '진심(수국꽃다발)' );"><span class="txt">SNS보내기</span></a></li>
                </ul>
            </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">진심(수국꽃다발)은 수국, 그린소재로 구성된 꽃다발 입니다.</span>
        </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">11위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">12위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
    ...
    <div class="gl_inner_item_wrap">
        ...
        <!--상품이미지-->
        <div class="gli_image goodsDisplayImageWrap">
            <a href="javascript:void(0);" class="respItemImageArea" onclick="display_goods_view('71','',this,'goods_view')">
                <img src="https://f-mans.com/data/goods/1/2024/06/71_temp_17173819305618list1.jpg" data-src="https://f-mans.com/data/goods/1/2024/06/71_temp_17173819305618list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="지금 이 순간">
            </a>
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">13위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
            ...
            <!-- 반응형 zzim -->
            <div class="respGoodsZzim">
                <a class="zzimArea" href="javascript:void(0)" onclick="display_goods_zzim(this, 71)">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim/icon_zzim.png" class="zzimImage normal " alt="찜하기" title="찜하기">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim_on/icon_zzim_on.png" class="zzimImage active hide" alt="찜한 상품" title="찜한 상품">
                </a>
            </div>
            ...
            <div class="respGoodsFuncMenu">
                <ul class="goodsDisplayItemWrap">
                    <li class="funcMenu_quickview"><a href="javascript:void(0)" onclick="display_goods_quickview(this, 71);"><span class="txt">미리보기</span></a></li>
                    <li class="funcMenu_option"><a href="javascript:void(0)" onclick="display_goods_show_opt(this, 71);"><span class="txt">옵션보기</span></a></li>
                    <li class="funcMenu_send"><a href="javascript:void(0)" onclick="display_goods_send(this,'bottom', '71', '지금 이 순간' );"><span class="txt">SNS보내기</span></a></li>
                </ul>
            </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        <!-- 상품명-->
        <div class="goodS_info displaY_goods_name">
            <span class="areA"><a href="/goods/view?no=71">지금 이 순간</a></span>
        </div>
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">지금 이 순간은 빨간장미와 계절꽃으로 구성된 꽃다발 입니다.</span>
        </div>
    ...
    <div class="gl_inner_item_wrap">
        ...
        <!--상품이미지-->
        <div class="gli_image goodsDisplayImageWrap">
            <a href="javascript:void(0);" class="respItemImageArea" onclick="display_goods_view('78','',this,'goods_view')">
                <img src="https://f-mans.com/data/goods/1/2023/11/78_temp_16995931625946list1.jpg" data-src="https://f-mans.com/data/goods/1/2023/11/78_temp_16995931625946list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="오늘의 행운">
            </a>
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">14위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
            ...
            <!-- 반응형 zzim -->
            <div class="respGoodsZzim">
                <a class="zzimArea" href="javascript:void(0)" onclick="display_goods_zzim(this, 78)">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim/icon_zzim.png" class="zzimImage normal " alt="찜하기" title="찜하기">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim_on/icon_zzim_on.png" class="zzimImage active hide" alt="찜한 상품" title="찜한 상품">
                </a>
            </div>
            ...
            <div class="respGoodsFuncMenu">
                <ul class="goodsDisplayItemWrap">
                    <li class="funcMenu_quickview"><a href="javascript:void(0)" onclick="display_goods_quickview(this, 78);"><span class="txt">미리보기</span></a></li>
                    <li class="funcMenu_option"><a href="javascript:void(0)" onclick="display_goods_show_opt(this, 78);"><span class="txt">옵션보기</span></a></li>
                    <li class="funcMenu_send"><a href="javascript:void(0)" onclick="display_goods_send(this,'bottom', '78', '오늘의 행운' );"><span class="txt">SNS보내기</span></a></li>
                </ul>
            </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        <!-- 상품명-->
        <div class="goodS_info displaY_goods_name">
            <span class="areA"><a href="/goods/view?no=78">오늘의 행운</a></span>
        </div>
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">오늘의 행운은 노란장미와 계절꽃, 그린소재로 구성된 꽃바구니 입니다.</span>
        </div>
    ...
    <div class="gl_inner_item_wrap">
        ...
        <!--상품이미지-->
        <div class="gli_image goodsDisplayImageWrap">
            <a href="javascript:void(0);" class="respItemImageArea" onclick="display_goods_view('216','',this,'goods_view')">
                <img src="https://f-mans.com/data/goods/1/2024/05/216_temp_17147262813200list1.jpg" data-src="https://f-mans.com/data/goods/1/2024/05/216_temp_17147262813200list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="썬셋 클래식 1호">
            </a>
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">15위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
            ...
            <!-- 반응형 zzim -->
            <div class="respGoodsZzim">
                <a class="zzimArea" href="javascript:void(0)" onclick="display_goods_zzim(this, 216)">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim/icon_zzim.png" class="zzimImage normal " alt="찜하기" title="찜하기">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim_on/icon_zzim_on.png" class="zzimImage active hide" alt="찜한 상품" title="찜한 상품">
                </a>
            </div>
            ...
            <div class="respGoodsFuncMenu">
                <ul class="goodsDisplayItemWrap">
                    <li class="funcMenu_quickview"><a href="javascript:void(0)" onclick="display_goods_quickview(this, 216);"><span class="txt">미리보기</span></a></li>
                    <li class="funcMenu_option"><a href="javascript:void(0)" onclick="display_goods_show_opt(this, 216);"><span class="txt">옵션보기</span></a></li>
                    <li class="funcMenu_send"><a href="javascript:void(0)" onclick="display_goods_send(this,'bottom', '216', '썬셋 클래식 1호' );"><span class="txt">SNS보내기</span></a></li>
                </ul>
            </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        <!-- 상품명-->
        <div class="goodS_info displaY_goods_name">
            <span class="areA"><a href="/goods/view?no=216">썬셋 클래식 1호</a></span>
        </div>
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">사랑스러운 나비를 닮은, 노랑호접란</span>
        </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">16위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">17위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">선명한 핑크빛 컬러의 무늬가 화려하고 아름다운, 분홍 호접란</span>
        </div>
        ...
        <div class="gli_image goodsDisplayImageWrap">
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">18위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
    ...
    <div class="gl_inner_item_wrap">
        ...
        <!--상품이미지-->
        <div class="gli_image goodsDisplayImageWrap">
            <a href="javascript:void(0);" class="respItemImageArea" onclick="display_goods_view('219','',this,'goods_view')">
                <img src="https://f-mans.com/data/goods/1/2023/10/219_temp_16972617353476list1.jpg" data-src="https://f-mans.com/data/goods/1/2023/10/219_temp_16972617353476list1.jpg" class="goodsDisplayImage lazyload" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" alt="연노랑호접란 엔틱라인">
            </a>
            ...
            <!-- 반응형 icon new -->
                ...
                <div class="respGoodsIcon typeText empty" style="background: #71a200">
                    <div class="respGoodsIconInner">
                        <div class="iconArea">
                            <span class="nuM">BEST</span><span class="secondMessage">19위</span>
                            <span class="nextMessage"></span><!-- 부가 텍스트 있는 경우, 없으면 항목 미노출 -->
                        </div>
                    </div>
                </div>
            ...
            <!-- 반응형 zzim -->
            <div class="respGoodsZzim">
                <a class="zzimArea" href="javascript:void(0)" onclick="display_goods_zzim(this, 219)">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim/icon_zzim.png" class="zzimImage normal " alt="찜하기" title="찜하기">
                    <img src="https://f-mans.com/data/icon/goodsdisplay/zzim_on/icon_zzim_on.png" class="zzimImage active hide" alt="찜한 상품" title="찜한 상품">
                </a>
            </div>
            ...
            <div class="respGoodsFuncMenu">
                <ul class="goodsDisplayItemWrap">
                    <li class="funcMenu_quickview"><a href="javascript:void(0)" onclick="display_goods_quickview(this, 219);"><span class="txt">미리보기</span></a></li>
                    <li class="funcMenu_option"><a href="javascript:void(0)" onclick="display_goods_show_opt(this, 219);"><span class="txt">옵션보기</span></a></li>
                    <li class="funcMenu_send"><a href="javascript:void(0)" onclick="display_goods_send(this,'bottom', '219', '연노랑호접란 엔틱라인' );"><span class="txt">SNS보내기</span></a></li>
                </ul>
            </div>
    ...
    <!-- +++++++++++++++++++++++++++++++++ NEW 상품 정보 ++++++++++++++++++++++++++++++++ -->
        <!-- 상품명-->
        <div class="goodS_info displaY_goods_name">
            <span class="areA"><a href="/goods/view?no=219">연노랑호접란 엔틱라인</a></span>
        </div>
        ...
        <!-- 짧은 설명 -->
        <div class="goodS_info displaY_goods_short_desc">
            <span class="areA">연노랑색의 고급스럽고 품격이 느껴지는 호접란</span>
        </div>
        ...
        <div class="resp_wrap">
            <ul class="menu1">
                <li class="foot_menu_d1 cs">
                    ...
                    <!-- <h4 class="title footer_kakao wide_only"><span designElement="text">카카오톡 문의</span></h4>
                    <ul class="list v4 wide_only">
                        <li><span designElement="text">@꽃집청년들 | 오전 8시 ~ 오후 10시</span></li>
                    </ul> -->
                </li>
