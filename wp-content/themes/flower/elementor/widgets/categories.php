...
function add_elementor_widget_categories11( $elements_manager ) {
...
class Elementor_Categories_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Test oEmbed', 'elementor-oembed-widget' );
    }
...
function add_elementor_widget_categories( $elements_manager ) {
    ...
    $elements_manager->add_category(
        'Boilerplate',
        [
            'title' => __( 'Boilerplate test', 'boilerplate-elementor-extension' ),
