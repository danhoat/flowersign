...
class Box_Products extends Products {
    ...
    public function get_title() {
        return esc_html__( 'Products V2', 'elementor-pro' );
    }
...
function register_list_widget_v2( $widgets_manager ) {
...
add_action( 'elementor/widgets/register', 'register_list_widget_v2' ,999);