    ...
    <?php foreach ($list as $key => $item) {
     ...
     ?>
       <li class="splide__slide is-active is-visible" id="splide02-slide09" style="margin-right: 8px; width: 142px;" aria-hidden="false" tabindex="0">
            <div class="relative">
                <input id="hiddenChoice332" type="checkbox" class="hidden_choice_checkbox " value="<?php echo $item->get_ID();?>" data-gtm-form-interact-field-id="0" name="bundles[]">
                <div class="addon-container flex flex-col justify-between px-3 pb-2 rounded-md border-2 border-blue-light text-center choice addon-box cursor-pointer hover:bg-gray-50" data-addonid="332">
                ...
                <img src="<?php echo $thumbnail_url;?>" alt="Gấu Bông Đáng Yêu" class="addon-image w-24 h-24 object-cover object-center my-1 self-center addon-img cursor-pointer" data-addonid="332">
