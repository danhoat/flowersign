    ...
    <ul class="main_bnr_c1">
        <li class="left_area">
            <a href="#">
                <!-- 좌측 긴배너 (627x242) -->
                </a><a href="/page/award" target="_self"><img src="<?php echo BOXTHEME_URL;?>/images/ban_award_2023.png" title="" alt=""></a>
                ...
                <li class="left_area">
                    <a href="#">
                        <!-- 좌측 하단 01 (205x200) -->
                            ...
                            <img src="<?php echo BOXTHEME_URL;?>/images/resp_bnr_main_102.jpg" title="" alt=""></a>
                ...
                <li class="center_area">
                    <a href="#">
                        <!-- 좌측 하단 02 (205x200) -->
                            ...
                            <img src="<?php echo BOXTHEME_URL;?>/images/resp_bnr_main_103.jpg" title="" alt=""></a>
